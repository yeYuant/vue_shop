        ...
        <el-tabs v-model="activeIndex" :tab-position="'left'" :before-leave="beforeTabLeave" @tab-click="tabClicked">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品价格" prop="goods_price">
              <el-input class="ipt-number" v-model="addGoodsForm.goods_price" type="number" onKeypress="return(/[\d\.]/.test(String.fromCharCode(event.keyCode)))"></el-input>
            </el-form-item>
            <el-form-item label="商品数量" prop="goods_number">
              <el-input class="ipt-number" v-model="addGoodsForm.goods_number" type="number" onKeypress="return(/[\d\.]/.test(String.fromCharCode(event.keyCode)))"></el-input>
            </el-form-item>
            <el-form-item label="商品重量(kg)" prop="goods_weight">
              <el-input class="ipt-number" v-model="addGoodsForm.goods_weight" type="number" onKeypress="return(/[\d\.]/.test(String.fromCharCode(event.keyCode)))"></el-input>
            </el-form-item>
            <el-form-item label="商品分类" prop="goods_cat">
              <el-cascader v-model="addGoodsForm.goods_cat" :options="cateList" :props="cateProps" @change="handleChange"></el-cascader>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="商品图片" name="3">
            ...
            <el-upload :action="uploadRUL" :on-preview="handlePreview" :on-remove="handleRemove" list-type="picture" :headers="headeObj" :on-success="handleSuccess">
...
export default {
  ...
  methods: {
    ...
    handleRemove(file) {
      ...
      const index = this.addGoodsForm.pics.findIndex((currentValue) => currentValue.pic === filePath)
